...
def test_invalid_patron_id_too_short():
    ...
    success, message = borrow_book_by_patron(patron_id= "1234", book_id= 1234567891234)
...
def test_invalid_book_id_too_short():
    ...
    success, message = borrow_book_by_patron(patron_id= "123456", book_id= 1234567)
...
def test_valid_patron_id():
    ...
    success, message = borrow_book_by_patron(patron_id= "123456", book_id= 1234567891234)
